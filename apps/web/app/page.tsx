    ...
    <main className="min-h-screen bg-amber-50 text-slate-800">
      ...
      <nav className="bg-slate-800 text-white p-4">
        <div className="max-w-5xl mx-auto flex justify-between items-center">
          ...
          <div className="space-x-4">
            ...
            <a href="#" className="hover:text-amber-300 transition-colors">Learn</a>
      ...
      <div className="max-w-5xl mx-auto px-4 py-8">
        ...
        <section className="mb-16">
          <h2 className="text-3xl font-bold text-center mb-8 text-slate-800">Why Choose Chess Master?</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md text-center">
              ...
              <h3 className="text-xl font-bold mb-2 text-amber-800">Fast Matchmaking</h3>
              <p className="text-slate-600">Find opponents at your skill level in seconds</p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md text-center">
              ...
              <h3 className="text-xl font-bold mb-2 text-amber-800">Advanced Analytics</h3>
              <p className="text-slate-600">Review your games and track your progress</p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md text-center">
              ...
              <h3 className="text-xl font-bold mb-2 text-amber-800">Interactive Lessons</h3>
              <p className="text-slate-600">Learn and improve with guided tutorials</p>
            </div>
          </div>
        </section>
        ...
        <section className="bg-slate-800 text-white rounded-xl p-8 text-center">
          ...
          <p className="text-lg mb-6 max-w-2xl mx-auto">Join thousands of players already enjoying Chess Master. Create your free account and start playing today.</p>
